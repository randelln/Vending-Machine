...
const DataTable = ({ products, runningTotal, setLoadingBuy, setRunningTotal, loadingProducts, fetchProducts, fetchCoins }) => {
  const checkout = (product) => {
    if (product.price > runningTotal) {
      ...
      fetch(`https://localhost:44383/vm/buy/${product.id}/${runningTotal}`, {
        method: 'get',
        headers: {
